# writing-beats — 記事をビートで組み立てるスキル（ローカル保存版）

> **出典**: https://github.com/mattpocock/skills （skills/in-progress/writing-beats/SKILL.md）
> **保存日**: 2026-07-07 — 元の置き場所が「in-progress」フォルダで移動が多く、リンク切れが起きたためローカル保存に切り替えた
> **使い方**: ノウハウ図書館の記事を書くとき、素材メモを渡して「このファイルの手法で組み立てて」と指示する。文体は `knowledge/writing.md` に従うこと。
